...
import graphGenerator.GraphFromRDFId
  ...
  def main(args: Array[String]) {
    ...
    args match {
      case Array(sourceFile, depth, numWalks) =>
        ...
        //val RanWalker = new biasRandomWalker(graph, depth.toInt, numWalks.toInt)
        ...
        val outputFile = new File(sourceFile).getParent + "/5_5" +
